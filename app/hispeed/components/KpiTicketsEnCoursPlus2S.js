...
export default function KpiTicketsEnCoursPlus2S() {
  ...
  useEffect(() => {
    fetchWithAuth(`https://myit-backend-ed72239b4b8e.herokuapp.comherokuapp.com/dashboard/api/hispeed/data/`)
  ...
  return (
    <div className="visualisation relative w-64" data-id={id}>
      <div className="relative bg-white p-6 rounded-xl shadow-md flex flex-col items-start w-full">
        ...
        {/* Titre & Période */}
        <h3 className="text-gray-800 text-lg font-medium">Tickets en Cours +14j</h3>
