...
export default function UploadEARFPage() {
  ...
  const handleUpload = async () => {
    if (!earfFile) {
      setUploadMessage("Veuillez sélectionner un fichier EARF.");
    ...
    try {
      ...
      if (res.ok) {
        setUploadMessage(data.message || "Le fichier EARF a été uploadé avec succès.");
    ...
    <main className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex flex-1 justify-center items-center pt-28 p-6">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-[#31327e] mb-6 text-center">Upload EARF</h1>

          <div className="w-full space-y-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Fichier EARF :</label>
