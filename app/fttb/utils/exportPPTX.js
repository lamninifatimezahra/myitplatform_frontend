...
export async function generatePPTFromImages(imageList, startDate = null, endDate = null) {
  ...
  intro.addText("Compte Rendu FTTB", { x: 0, y: 2.5, w: "100%", h: 0.7, align: "center", fontFace: "Segoe UI", fontSize: 36, bold: true, color: "FFFFFF" });
...
// --- Slide de fin avec logo ---
  ...
  const fileName = `compte_rendu_FTTB_${todayStr}.pptx`;
  try {
