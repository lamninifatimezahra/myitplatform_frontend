...
export default function HeaderForum({ setSidebarOpen }) {
  ...
  return (
    <motion.header
      ...
      className="bg-white shadow-md px-4 md:px-6 py-4 flex justify-between items-center gap-4 flex-wrap"
    >
      {/* Burger menu mobile */}
      ...
      <div className="flex items-center gap-6">
        <a className="font-semibold text-[#31327e] border-b-2 border-[#31327e] pb-1 hidden md:inline" href="#">
          Accueil
        </a>
        <a className="text-gray-500 hover:text-[#31327e] hover:underline hidden md:inline" href="#">
          Top posts
        </a>
      </div>
      ...
      <div className="flex items-center gap-3 ml-auto">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-10 pr-4 py-2 rounded-full bg-gray-100 text-sm border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#68bddd]"
          />
        </div>
