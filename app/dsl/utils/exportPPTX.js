...
export async function generatePPTFromImages(imageList, startDate = null, endDate = null) {
  ...
  intro.addText("Compte Rendu DSL", { x: 0, y: 2.5, w: "100%", h: 0.7, align: "center", fontFace: "Segoe UI", fontSize: 36, bold: true, color: "FFFFFF" });
...
if (standardGraphImages.length > 0) {
  ...
  const fileName = `compte_rendu_DSL_${todayStr}.pptx`;
  try {
